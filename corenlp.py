...
class StanfordCoreNLPEs(object):
    """
    ...
    def __init__(self, corenlp_path=None):
        ...
        jars = ["stanford-corenlp-3.4.1.jar",
                "stanford-spanish-corenlp-2014-08-26-models.jar",                
                "joda-time.jar",
                "xom.jar",
                "jollyday.jar"]
        ...
        props = "-props spanish.properties" 
...
if __name__ == '__main__':
    ...
    parser.add_option('-l', '--lang', default='english',
                      help='spanish or english')
 
    options, args = parser.parse_args()
    server = jsonrpc.Server(jsonrpc.JsonRpc20(),
                            jsonrpc.TransportTcpIp(addr=(options.host, int(options.port))))
    
    if options.lang.startswith('spanish'):
        nlp = StanfordCoreNLPEs()
    else:
        nlp = StanfordCoreNLP()
